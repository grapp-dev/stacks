...
const App = () => {
  return (
    <Device>
      <Box flex="fluid" alignY="center" alignX="center" padding={4}>
        <Box marginBottom={8} alignX="center">
          <Typography variant="h2">Hello!</Typography>
        </Box>
        <Box style={styles.root} padding={8} alignX="center" alignY="center" marginBottom={8}>
          <Image name="rocket" width={96} />
        </Box>
        <Typography variant="body">Welcome to the Stacks documentation 🔥</Typography>
      </Box>
    </Device>
  )
}
...
const App = () => {
  return (
    <Box style={styles.root} direction="row" alignX="between">
      <Box alignY="top">
